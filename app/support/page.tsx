...
export default function SupportPage() {
  return (
    <LegalShell eyebrow="SUPPORT" title="支持与反馈" intro="安装失败、来源错误、投稿撤回和安全问题都可以从这里进入正确渠道。">
      <section><h2>先做快速检查</h2><ul><li>确认 Skill 来自固定版本的官方 GitHub 仓库。</li><li>安装后开启一个新 Codex 对话，再输入 <code>$skindex</code>。</li><li>原生主题需要在 Codex → Settings → Appearance → Import 中完成最终确认。</li></ul></section>

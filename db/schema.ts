...
export const submissions = sqliteTable("submissions", {
  ...
  platform: text("platform").notNull(),
  engine: text("engine").notNull().default("dream-skin"),
  capabilities: text("capabilities").notNull().default("[]"),
  verifiedInCodex: integer("verified_in_codex", { mode: "boolean" }).notNull().default(false),
...
export const themeProposals = sqliteTable("theme_proposals", {
  ...
  authorName: text("author_name").notNull(),
  platform: text("platform").notNull(),
  engine: text("engine").notNull().default("skindex-native"),
  capabilities: text("capabilities").notNull().default("[]"),
